...
const formSchema = z.object({
    ...
    value: z.string().min(4).regex(/^#/, {
      message: 'La chaîne doit être un code hexadecimal',
    })
});
...
export const ColorForm: React.FC<ColorFormProps> = ({
    ...
    const description = initialData ? "Modifier une couleur" : "Ajouter une nouvelle couleur"
    const toastMessage = initialData ? "Couleur mise à jour" : "Couleur crée"
    ...
    const onDelete = async () => {
        try{
            ...
            toast.error("Supprimez tous les produits utilisant cette couleur d'abord.")
        } finally{
            setLoading(false)
            setOpen(false)
        }
