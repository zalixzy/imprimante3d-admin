...
export const SizeForm: React.FC<SizeFormProps> = ({
    ...
    const title = initialData ? "Modifier la taille" : "Créer une nouvelle taille"
    const description = initialData ? "Modifier une taille" : "Ajouter une nouvelle taille"
    const toastMessage = initialData ? "Taille mise à jour" : "Taille crée"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input disabled={loading} placeholder="Nom de la valeur" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
